          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Connect with certified fitness professionals, book personalized
                sessions, and achieve your fitness goals with expert guidance
                and support.
              </p>
              ...
              <div className="bg-gradient-to-br from-blue-400 to-purple-600 rounded-2xl p-8 text-white">
                <div className="text-center">
                  ...
                  <p className="text-blue-100">
                    Join thousands of people who have achieved their fitness
                    goals
                  </p>
                </div>
              </div>
